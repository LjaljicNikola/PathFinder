        ...
        <div className="flex min-h-screen">
            <div className="hidden w-1/2 flex-col items-center justify-center bg-blue-900 p-12 lg:flex">
                ...
                <p className="text-center text-lg text-blue-200">
                    Kreirajte nalog i počnite planirati vaše savršeno putovanje već danas.
                </p>
            </div>
            ...
            <div className="flex w-full flex-col items-center justify-center bg-slate-50 p-8 lg:w-1/2">
                <div className="w-full max-w-sm">
                    ...
                    <h2 className="mb-2 text-2xl font-semibold text-slate-800">Kreirajte nalog</h2>
                    <p className="mb-6 text-sm text-slate-500">Registrujte se i počnite planirati</p>
                    ...
                    <p className="mt-4 text-center text-sm text-slate-500">
                        Već imate nalog?{' '}
                        <Link to="/prijava" className="font-medium text-blue-700 hover:underline">
                            Prijavite se
                        </Link>
                    </p>
                </div>
